# Emulate tractor's choice of WISE coadd in overlapping regions by choosing 
# the last coadd in the coadd table
...
def query_wise_coadd(ra, dec, n_match, coadd_fn=coadd_fn, verbose=True):
    ...
    # For objects inside more than one coadd, choose the coadd with the 
